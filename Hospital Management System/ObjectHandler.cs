...
namespace SkyLines
{
    ...
    internal class ObjectHandler
    {
        ...
        //static IAdminDL AdminDL = AdminDL_DB.GetAdminDL_DBInstance(connectionstring);
        ...
        private static IAdminDL AdminDL = AdminDL_FH.GetAdminDL_FHInstance("D:\\Semester 02\\Semester 02 Projects\\Skylines\\AMSNew1\\SKYLINES(Admins).txt");
        private static IStaffDL StaffDL = StaffDL_FH.GetStaffDL_FHInstance("D:\\Semester 02\\Semester 02 Projects\\Skylines\\AMSNew1\\SKYLINES(Staff).txt");
        private static IFlightDL FlightDL = FlightDL_FH.GetFlightDL_FHInstance("D:\\Semester 02\\Semester 02 Projects\\Skylines\\AMSNew1\\SKYLINES(Flights).txt");
        private static IClientDL ClientDL = ClientDL_FH.GetClientDL_FHInstance("D:\\Semester 02\\Semester 02 Projects\\Skylines\\AMSNew1\\SKYLINES(Clients).txt");
